...
(cl:defmethod cl:initialize-instance :after ((m <custom_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'custom_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_send-msg:<custom_msg> is deprecated: use msg_send-msg:custom_msg instead.")))
...
(cl:defmethod phone_number-val ((m <custom_msg>))
...
(cl:defmethod id_number-val ((m <custom_msg>))
